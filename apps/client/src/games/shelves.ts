...
export const SHELVES: readonly { readonly title: string; readonly ids: readonly string[] }[] = [
  {
    ...
    ids: ['air-hockey', 'ping-pong', 'tug-of-war', 'reflex-race', 'sumo', 'balloon-bumpers', 'stampede', 'penalty-kicks', 'snake-battle', 'spinner-war', 'racing', 'sword-duel', 'whack-a-mole', 'paint-fight', 'grab-it', 'bomb-pass', 'brick-blast', 'sling-puck', 'hoops', 'tank-duel', 'road-dodge', 'slot-cars', 'wheelie', 'gravity-run', 'pool', 'mini-golf', 'archery', 'darts', 'flick-football'],
  },
  {
    title: 'Board games',
  ...
  {
    title: 'Puzzles',
    ids: ['2048', 'sudoku', 'nonogram', 'sweeper', 'flood', 'color-sort', 'tile-match', 'mahjong', 'block-puzzle', 'pointers', 'maze-paint', 'ball-run', 'marble-run', 'pizza-memory', 'escape-room', 'fruit-merge', 'sliding-puzzle', 'jigsaw', 'memory', 'echo', 'classic-snake'],
  },
