...
export const SHELVES: readonly { readonly title: string; readonly ids: readonly string[] }[] = [
  {
    ...
    ids: ['air-hockey', 'ping-pong', 'tug-of-war', 'reflex-race', 'sumo', 'penalty-kicks', 'snake-battle', 'spinner-war', 'racing', 'sword-duel', 'whack-a-mole', 'paint-fight', 'grab-it', 'pool', 'mini-golf', 'archery'],
  },
  {
    title: 'Board games',
  ...
  { title: 'Words and numbers', ids: ['word-guess', 'word-search', 'mini-crossword', 'word-ladder', 'word-groups', 'anagram-hunt', 'target-number', 'quick-maths', 'number-match', 'code-breaker'] },
  {
    title: 'Puzzles',
  ...
  { title: 'Chill', ids: ['pop-it', 'zen-garden'] },
];
