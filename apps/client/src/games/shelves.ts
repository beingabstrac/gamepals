...
export const SHELVES: readonly { readonly title: string; readonly ids: readonly string[] }[] = [
  {
    ...
    ids: ['air-hockey', 'ping-pong', 'tug-of-war', 'reflex-race', 'sumo', 'penalty-kicks', 'snake-battle', 'spinner-war', 'racing', 'sword-duel', 'whack-a-mole', 'paint-fight', 'grab-it', 'bomb-pass', 'brick-blast', 'sling-puck', 'hoops', 'tank-duel', 'road-dodge', 'slot-cars', 'wheelie', 'pool', 'mini-golf', 'archery'],
  },
  {
    title: 'Board games',
    ids: ['tic-tac-toe', 'four-in-a-row', 'ultimate-ttt', 'checkers', 'chess', 'reversi', 'go', 'hex', 'backgammon', 'ludo', 'snakes-and-ladders', 'sea-battle', 'dots-and-boxes', 'mancala', 'morris', 'chinese-checkers', 'guess-person', 'dominoes', 'yatzy', 'shut-the-box'],
  },
  { title: 'Games from long ago', ids: ['ur', 'senet', 'pachisi', 'chowka', 'tafl', 'fanorona'] },
  {
    title: 'Cards',
  ...
  {
    title: 'Puzzles',
    ids: ['2048', 'sudoku', 'nonogram', 'sweeper', 'flood', 'color-sort', 'tile-match', 'mahjong', 'block-puzzle', 'pointers', 'maze-paint', 'fruit-merge', 'sliding-puzzle', 'jigsaw', 'memory', 'echo', 'classic-snake'],
  },
