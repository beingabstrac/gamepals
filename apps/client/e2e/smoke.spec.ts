...
const GAMES = ['Tic-Tac-Toe', 'Four in a Row', 'Ludo', 'Air Hockey', 'Ping Pong', 'Tug of War', 'Reflex Race', 'Sumo', 'Penalty Kicks', 'Snake Battle', '2048', 'Sudoku', 'Solitaire', 'FreeCell', 'Spider', 'Pyramid', 'TriPeaks', 'Crazy Eights', 'Go Fish', 'War', 'Old Maid', 'Hearts', 'Spades', 'Callbreak', 'Gin Rummy', 'Rummy', 'Word Guess', 'Word Search', 'Mini Crossword', 'Word Ladder', 'Word Groups', 'Anagram Hunt', 'Target Number', 'Quick Maths', 'Memory', 'Sliding Puzzle', 'Sweeper', 'Flood', 'Tile Match', 'Jigsaw', 'Pool', 'Mini Golf', 'Archery', 'Spinner War', 'Racing', 'Sword Duel', 'Whack-a-Mole', 'Paint Fight', 'Grab It', 'Bomb Pass', 'Brick Blast', 'Sling Puck', 'Basketball Hoops', 'Tank Duel', 'Road Dodge', 'Slot Cars', 'Wheelie', 'Speed', 'Gravity Run', 'Impostor', 'Charades', 'Draw & Guess', 'Guess the Person', 'Royal Game of Ur', 'Senet', "Nine Men's Morris", 'Pachisi', 'Go 9×9', 'Hnefatafl', 'Fanorona', 'Chowka Bhara', 'Code Breaker', 'Hex', 'Chinese Checkers', 'Nonogram', 'Mahjong Solitaire', 'Block Puzzle', 'Number Match', '2248', 'Maze Paint', 'Ball Run', 'Fruit Merge', 'Tower', 'Switch Board', 'Clean It', 'Straighten Up', 'Sand Fall', 'Domino Topple', 'Darts', 'Connect Six', 'Game of the Goose', 'Pond', 'Wind Chimes', 'Slime', 'Marble Run', 'Mirror Paint', 'Pizza Memory', 'Escape Room', 'Balloon Bumpers', 'Flick Football', 'Stampede', 'Gomoku', 'Oware', 'Mexican Train', 'Pop It', 'Zen Garden', "Newton's Cradle", 'Would You Rather', 'Truth or Dare', 'Hangman', 'Pointers', 'Color Sort', 'Echo', 'Classic Snake', 'Checkers', 'Chess', 'Backgammon', 'Sea Battle', 'Reversi', 'Dots & Boxes', 'Mancala', 'Snakes & Ladders', 'Ultimate Tic-Tac-Toe', 'Yatzy', 'Shut the Box', 'Dominoes'];
