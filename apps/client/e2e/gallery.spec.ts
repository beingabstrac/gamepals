...
const GAMES = [
  ...
  '2048', 'Sudoku', 'Solitaire', 'FreeCell', 'Spider', 'Memory', 'Sliding Puzzle', 'Color Sort', 'Echo', 'Classic Snake',
...
for (const name of GAMES) {
  test(`${name}: gallery shot @full`, async ({ page }, testInfo) => {
    ...
    // Long enough for a few moves, short enough that quick games are not over.
