...
const BANDED = ['Word Guess', 'Word Search', 'Mini Crossword', 'Word Ladder', 'Word Groups', 'Anagram Hunt', 'Target Number', 'Quick Maths', 'Flood', 'Mini Golf', 'Archery', 'Impostor', 'Charades', 'Draw & Guess', 'Guess the Person', 'Go 9×9', 'Hnefatafl', 'Fanorona', 'Code Breaker'];
