...
const BANDED = ['Word Guess', 'Word Search', 'Mini Crossword', 'Word Ladder', 'Word Groups', 'Anagram Hunt', 'Target Number', 'Quick Maths', 'Flood', 'Mini Golf', 'Archery', 'Darts', 'Game of the Goose', 'Impostor', 'Charades', 'Draw & Guess', 'Guess the Person', 'Go 9×9', 'Hnefatafl', 'Fanorona', 'Code Breaker', 'Hex', 'Nonogram', 'Block Puzzle', 'Number Match', 'Would You Rather', 'Truth or Dare', 'Hangman', 'Pointers'];
