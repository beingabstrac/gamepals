...
- [ ] **M4a Backgammon:** full rules (bar, hitting, bearing off, must use both dice, higher die when only one fits, doubles give four moves), 4 bot levels
- [ ] **M4b Sea Battle:** place your fleet, take shots, hidden boards on one device, a bot that hunts properly; wave 4 complete
