...
- [ ] Wave 4 board games (brief each first): [x] Checkers, [x] Reversi, [x] Dots & Boxes, [x] Mancala, [x] Snakes & Ladders, [ ] Chess, [ ] Dominoes, [x] Ultimate TTT, [ ] Yatzy, [ ] Shut the Box, [ ] Backgammon
