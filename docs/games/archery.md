...
- **Scoring** by ring, 10 to 1, a miss is 0; the X counts for ties. The running totals sit across the top.
- **Touch**: drag anywhere to move the sight and let go to shoot. **Keyboard**: arrows move the sight (Shift for small steps), Space shoots. The sight steadies for a second after your turn starts and then tires, so waiting too long costs you.
